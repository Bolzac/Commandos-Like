...
{
  public delegate void LinkEvent(Vector3 lookPos);
   ...
   IEnumerator Start () {
     ...
     while (true) {
       if (agent.isOnOffMeshLink) {
         onLinkStarts?.Invoke(agent.currentOffMeshLinkData.endPos);
         ...
         onLinkEnds?.Invoke(agent.currentOffMeshLinkData.endPos);
       }
       yield return null;
     }
   }
